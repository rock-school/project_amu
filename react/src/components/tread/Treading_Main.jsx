export default function Treading_Main() {
  return (
    <div>
      <h2 className="widget-title h4 m-b">Treading</h2>
      <div className="owl-carousel owl-theme owl-dots-center" data-ui-jp="owlCarousel" data-ui-options="{
                                margin: 20,
        ...
        <div className="">
          <div className="item r" data-id="item-3"
            ...
            <div className="item-media item-media-4by3">
